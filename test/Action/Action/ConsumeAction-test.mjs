...
describe("Action | ConsumeAction", () => {
  ...
  it("returns fields if fields present", async () => {
    let action = await ConsumeAction({ Cons: { ["identifier", "mainEntityOfPage"]})
